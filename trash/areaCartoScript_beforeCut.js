...
var percent = (function() {
    ...
    fields = [
        ...
        {name: "Agricultural Land", id: "agriculturalLand", key: "agriculturalLand"},
...
var proj = d3.geo.mercator().translate([950/2, 600/2])
    .scale(125),
    topology,
    geometries,
    rawData,
...
d3.json("./ne_110m_admin_0_countries.topojson", function(topo) {
    console.log(topo);
    topology = topo;
    geometries = topology.objects.ne_110m_admin_0_countries.geometries;
    d3.csv("./soilDataMapNames.csv", function(data) {
        rawData = data;
        dataById = d3.nest()
